...
<body class="bg-slate-50 text-slate-900 antialiased">
    ...
    <header class="sticky top-0 z-40 border-b border-slate-200 bg-white/90 backdrop-blur-md">
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4">
                <a href="help-center.php" class="text-sm font-semibold text-slate-700 hover:text-blue-600">Pusat Bantuan</a>
                <a href="forum.php" class="text-sm font-semibold text-slate-700 hover:text-blue-600">Forum</a>
    ...
    <main class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="rounded-lg bg-purple-50 p-3 w-fit mb-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm max-w-2xl mx-auto">
            ...
            <form id="contactForm" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-900 mb-2">Telepon (Opsional)</label>
                    <input 
                        type="tel" 
                        name="phone"
                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
            ...
            <!-- Success Message -->
            <div id="successMessage" class="hidden mt-6 p-4 rounded-lg bg-green-50 border border-green-200">
                <p class="text-green-800 font-semibold">✓ Pesan Anda berhasil dikirim!</p>
                <p class="text-green-700 text-sm mt-1">Admin akan segera memproses dan menghubungi Anda kembali.</p>
            </div>

            <!-- Error Message -->
            <div id="errorMessage" class="hidden mt-6 p-4 rounded-lg bg-red-50 border border-red-200">
                <p class="text-red-800 font-semibold" id="errorText">Terjadi kesalahan!</p>
            </div>
        </div>
    </main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    <div class="flex items-center gap-2 mb-4">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600 text-sm font-black text-white">C</div>
                        <span class="font-black text-white">CourseUp</span>
                    </div>
                    <p class="text-sm text-slate-400">Platform e-learning terpercaya untuk pembelajaran web development.</p>
                </div>
                <div>
                    <h4 class="text-sm font-bold text-white mb-4">Platform</h4>
                    <ul class="space-y-2 text-sm text-slate-400">
                        <li><a href="courses.php" class="hover:text-white">Kursus</a></li>
                        <li><a href="quiz.php" class="hover:text-white">Quiz</a></li>
                        <li><a href="forum.php" class="hover:text-white">Forum</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-sm font-bold text-white mb-4">Dukungan</h4>
                    <ul class="space-y-2 text-sm text-slate-400">
                        <li><a href="help-center.php" class="hover:text-white">Pusat Bantuan</a></li>
                        <li><a href="contact.php" class="hover:text-white">Hubungi Kami</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate-400">
                        ...
                        <li><a href="#" class="hover:text-white">Syarat & Kondisi</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-slate-800 pt-8 text-center text-sm text-slate-400">
                <p>&copy; 2024 CourseUp. Semua hak cipta dilindungi.</p>
            </div>
        </div>
    </footer>

  ...
  <body data-page="courses" class="bg-gradient-to-b from-slate-50 to-emerald-50 text-slate-900 antialiased">
    <header class="sticky top-0 z-40 border-b border-emerald-300/30 bg-white/70 backdrop-blur-md">
      <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden items-center gap-8 text-sm font-medium text-slate-700 md:flex">
          ...
          <a href="courses.php" class="font-semibold bg-gradient-to-r from-ocean-700 to-emerald-600 bg-clip-text text-transparent">Kursus Materi</a>
    ...
    <main class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section class="mb-8 text-center" data-aos="fade-up">
        <span class="inline-flex rounded-full border border-emerald-300/50 bg-emerald-50/50 backdrop-blur-sm px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-700">📚 Kursus Materi</span>
        <h1 class="mt-4 text-4xl font-black text-slate-900">Belajar Web Developer dengan materi yang siap dipakai</h1>
        <p class="mt-3 text-lg text-slate-600">Akses semua materi pembelajaran dalam format PDF yang mudah dipelajari</p>
      </section>
